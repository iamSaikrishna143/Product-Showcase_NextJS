...
export const metadata: Metadata = {
  ...
  description:
    "Discover TechStore - a curated collection of state-of-the-art smartphones, laptops, audio gear, and wearables designed for peak performance and elegant aesthetics.",
  keywords: [
    "electronics",
    "next.js store",
    "smartphones",
  ...
  openGraph: {
    ...
    description:
      "Explore the finest high-performance consumer tech devices in our premium showcase.",
  ...
  twitter: {
    ...
    title: "TechStore | Premium Electronics Showcase",
    description:
      "Explore high-performance consumer tech devices in our premium showcase.",
    images: [
      "https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=1200&auto=format&fit=crop&q=60",
    ],
  },
};
